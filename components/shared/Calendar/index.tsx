...
export function Calendar() {
    ...
    useEffect(() => {
        if (month || year) {
            ...
            } else if ([3, 5, 8, 10].includes(monthIndex)) { // April, June, September, November
                daysInMonth = 30
            } else {
                daysInMonth = 31
            }
    ...
    return (
        <div className="w-full max-w-sm space-y-4">
            ...
            <div className="grid grid-cols-3 gap-2">
                <Select value={year} onValueChange={setYear} name="year">
                    <SelectTrigger>
                ...
                <Select value={month} onValueChange={setMonth} name="month">
                    <SelectTrigger>
                ...
                <Select value={day} onValueChange={setDay} name="day">
                    <SelectTrigger>
